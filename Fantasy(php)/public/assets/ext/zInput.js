	...
	$.each(inputNames, function(index,value){
		...
		if (elementType == "radio"){
			$element.wrap(function(){
				return '<div class="zInput" coin="'+ $(this).attr('coin') +'" icon="'+$(this).attr('src')+'">' +
						'<span style="display:table;width: 100%;height: 100%;">' +
						'<img src="'+$(this).attr('src')+'" class="centra-log-img"/>'+
						'<span style="display: table-cell;vertical-align:middle;">' + $(this).attr("title") + '</span>' +
						'</span>' +
						'</div>';
			});
		}
		...
		{
			$element.wrap(function(){
				return '<div class="zInput zCheckbox1" id="'+ $(this).attr('coin') +'" coin="'+ $(this).attr('coin') +'">' +
						'<span style="display:table;width: 100%;height: 100%;">' +
						'<img src="'+$(this).attr('src')+'" class="centra-log-img"/>'+
						'<span style="display: table-cell;vertical-align:middle;">' + $(this).attr("title") + '</span>' +
						'</span>' +
