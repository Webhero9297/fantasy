$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'theme/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'theme/css/bootstrap-' + themeName + '.min.css');
        }
    ...
    $('a.ajax-centra-asset-link').click(function (e) {
        if (msie) e.which = 1;
        //if (e.which != 1 || !$('#is-ajax').prop('checked') || $(this).parent().hasClass('active')) return;
        e.preventDefault();
        //$('.sidebar-nav').removeClass('active');
